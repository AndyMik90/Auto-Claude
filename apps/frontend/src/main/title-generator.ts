...
import { findPythonCommand, parsePythonCommand, getValidatedPythonPath } from './python-detector';
...
export class TitleGenerator extends EventEmitter {
  ...
  configure(pythonPath?: string, autoBuildSourcePath?: string): void {
    if (pythonPath) {
      this.pythonPath = getValidatedPythonPath(pythonPath, 'TitleGenerator');
    }
