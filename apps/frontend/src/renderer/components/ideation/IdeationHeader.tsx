...
export function IdeationHeader({
  ...
  const { t } = useTranslation(['common', 'navigation', 'ideation']);
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <Badge variant="outline">{totalIdeas} {t('ideation.ideas')}</Badge>
          </div>
          <p className="text-sm text-muted-foreground">
            {t('ideation.aiGeneratedDescription')}
          </p>
        </div>
          ...
          {hasSelection ? (
            <>
              <Badge variant="secondary" className="mr-1">
                {selectedCount} {t('ideation.selected')}
              </Badge>
              <Button
                variant="outline"
                size="sm"
