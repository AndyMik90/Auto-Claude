        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-lg font-semibold">{t('generationProgress.title')}</h2>
              <Badge variant="outline">
                {t('generationProgress.complete', { count: completedCount, total: enabledTypes.length })}
              </Badge>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {showLogs ? t('generationProgress.hideLogs') : t('generationProgress.showLogs')}
            </Button>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {isStopping ? t('generationProgress.stopping') : t('generationProgress.stop')}
                </Button>
              </TooltipTrigger>
              <TooltipContent>{t('generationProgress.stopTooltip')}</TooltipContent>
            </Tooltip>
          </div>
        </div>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {enabledTypes.map((type) => (
            ...
            >
              ...
              <TypeIcon type={type} />
              <span>{getIdeationTypeLabels(t)[type]}</span>
            ...
            return (
              <div key={type}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-medium">{getIdeationTypeLabels(t)[type]}</h3>
                  <TypeStateIcon state={state} />
                  {ideas.length > 0 && (
                    <Badge variant="outline" className="ml-auto">
                      {t('generationProgress.ideas', { count: ideas.length })}
                    </Badge>
                  )}
                </div>
