        ...
        <DialogContent>
          ...
          <div className="py-4 space-y-4 max-h-96 overflow-y-auto">
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('ideation:dialogs.config.ideationTypes')}</h4>
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('ideation:dialogs.config.contextSources')}</h4>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={onCloseConfigDialog}>
              {t('ideation:dialogs.config.close')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
          ...
          <DialogFooter className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={onCloseAddMoreDialog}>
                {t('ideation:dialogs.addMore.cancel')}
              </Button>
              <Button
