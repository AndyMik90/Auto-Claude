        ...
        <DialogContent>
          ...
          <div className="py-4 space-y-4 max-h-96 overflow-y-auto">
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('config.typesTitle')}</h4>
              {ALL_IDEATION_TYPES.map((type) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-sm">{t(`types.${type}.label`)}</div>
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('config.contextTitle')}</h4>
          ...
          <div className="py-4 space-y-3 max-h-96 overflow-y-auto">
            {availableTypesToAdd.length === 0 ? (
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p className="text-sm mt-1">{t('addMore.regenerateTip')}</p>
              </div>
            ) : (
          ...
          <DialogFooter className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                {typesToAdd.length > 0 ? t('addMore.generate', { count: typesToAdd.length }) : t('addMore.generateGeneric')}
              </Button>
            </div>
          </DialogFooter>
        </DialogContent>
