    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Card className="p-3 text-center">
          ...
          <div className="text-xs text-muted-foreground">{t('securityHardening.files')}</div>
        </Card>
      </div>
      ...
      {idea.vulnerability && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('securityHardening.vulnerability')}
          </h3>
      ...
      <div>
        <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
          ...
          {t('securityHardening.currentRisk')}
        </h3>
      ...
      <div>
        <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
          ...
          {t('securityHardening.remediation')}
        </h3>
      ...
      {idea.references && idea.references.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('securityHardening.references')}
          </h3>
          <ul className="space-y-1">
      ...
      {idea.compliance && idea.compliance.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2">{t('securityHardening.compliance')}</h3>
