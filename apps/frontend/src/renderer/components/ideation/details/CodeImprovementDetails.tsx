    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Card className="p-3 text-center">
          ...
          <div className="text-xs text-muted-foreground">{t('codeImprovement.files')}</div>
        </Card>
      </div>
      ...
      {idea.implementationApproach && (
        <div>
          <h3 className="text-sm font-medium mb-2 flex items-center gap-2">
            ...
            {t('codeImprovement.implementationApproach')}
          </h3>
      ...
      {idea.existingPatterns && idea.existingPatterns.length > 0 && (
        <div>
          <h3 className="text-sm font-medium mb-2">{t('codeImprovement.patternsToFollow')}</h3>
          <ul className="space-y-1">
