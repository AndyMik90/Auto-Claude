...
export type AppSection = 'appearance' | 'display' | 'language' | 'terminal' | 'devtools' | 'agent' | 'paths' | 'integrations' | 'api-profiles' | 'updates' | 'notifications' | 'debug';
...
export function AppSettingsDialog({ open, onOpenChange, initialSection, initialProjectSection, onRerunWizard }: AppSettingsDialogProps) {
  ...
  const renderAppSection = () => {
    switch (appSection) {
      ...
      case 'terminal':
        return <TerminalSettings settings={settings} onSettingsChange={setSettings} />;
      case 'devtools':
