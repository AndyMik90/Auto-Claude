      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted/50 p-3">
            <div className="flex items-center gap-2 text-sm font-medium">
              ...
              {t('including', { count: summaryInfo.count, label: summaryInfo.label })}
            </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm">{t('releaseInfo')}</CardTitle>
          </CardHeader>
            ...
            {(existingChangelog?.lastVersion || versionBumpDescription) && (
              <div className="text-xs text-muted-foreground space-y-1">
                {existingChangelog?.lastVersion && (
                  <p>{t('previousVersion', { version: existingChangelog.lastVersion })}</p>
                )}
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm">{t('outputStyle')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
