    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-base">{t('createGithubRelease')}</CardTitle>
        </div>
      </CardHeader>
      <CardContent>
        {releaseUrl ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-success">
              ...
              <span className="text-sm">{t('releaseCreatedSuccess')}</span>
            </div>
            <Button
              variant="outline"
              size="sm"
            ...
            >
              ...
              {t('viewReleaseOnGithub')}
            </Button>
          </div>
        ) : (
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              {t('createGithubReleaseDescription', { tag })}
            </p>
            {releaseError && (
