    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-base">{t('changelog.createGitHubRelease')}</CardTitle>
        </div>
      </CardHeader>
      <CardContent>
        {releaseUrl ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-success">
              ...
              <span className="text-sm">{t('changelog.releaseCreated')}</span>
            </div>
            <Button
              variant="outline"
              size="sm"
            ...
            >
              ...
              {t('changelog.viewReleaseOnGitHub')}
            </Button>
          </div>
        ) : (
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              {t('changelog.createReleaseTag', { tag })}
            </p>
            {releaseError && (
