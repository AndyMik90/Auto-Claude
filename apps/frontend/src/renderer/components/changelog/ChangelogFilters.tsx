      ...
      <div className="p-6 space-y-6">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-sm">
                    {t('source.branchComparison')}
                  </span>
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  {t('source.branchComparisonDesc')}
                </p>
              </div>
            </label>
          </RadioGroup>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {gitHistoryType === 'recent' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('gitOptions.commitCount')}</Label>
                  <Input
                    type="number"
                    min={1}
                    max={500}
              ...
              {gitHistoryType === 'since-date' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('gitOptions.dateLabel')}</Label>
                  <Input
                    type="date"
              ...
              {gitHistoryType === 'since-version' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('gitOptions.versionLabel')}</Label>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t('gitOptions.allCommitsIncluded')}
                  </p>
                </div>
              )}
        ...
        {sourceMode === 'branch-diff' && (
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label className="text-xs">{t('branches.baseBranch')}</Label>
                <Select value={baseBranch} onValueChange={onBaseBranchChange}>
                  <SelectTrigger>
                    <SelectValue placeholder={t('branches.baseBranchPlaceholder')} />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {t('branches.baseBranchHint')}
                </p>
              </div>

              <div className="space-y-2">
                <Label className="text-xs">{t('branches.compareBranch')}</Label>
                <Select value={compareBranch} onValueChange={onCompareBranchChange}>
                  <SelectTrigger>
                    <SelectValue placeholder={t('branches.compareBranchPlaceholder')} />
                  </SelectTrigger>
                  <SelectContent>
                    {localBranches.map((branch) => (
                      <SelectItem key={branch.name} value={branch.name}>
