    ...
    >
      ...
      {envConfig.graphitiEnabled && (
        <>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="font-normal text-foreground">{t('memory.agentAccess.label')}</Label>
              <p className="text-xs text-muted-foreground">
                {t('memory.agentAccess.description')}
              </p>
            </div>
            <Switch
          ...
          {settings.graphitiMcpEnabled && (
            <div className="space-y-2 ml-6">
              <Label className="text-sm font-medium text-foreground">{t('memory.mcpServer.label')}</Label>
              <p className="text-xs text-muted-foreground">
                {t('memory.mcpServer.description')}
              </p>
              <Input
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium text-foreground">{t('memory.embedding.provider')}</Label>
            <p className="text-xs text-muted-foreground">
              {t('memory.embedding.description')}
            </p>
            <Select
            ...
            >
              <SelectTrigger>
                <SelectValue placeholder={t('memory.embedding.selectPlaceholder')} />
              </SelectTrigger>
              <SelectContent>
          ...
          {embeddingProvider === 'voyage' && (
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                <Label className="text-xs text-muted-foreground">{t('memory.embedding.model')}</Label>
                <Input
          ...
          {embeddingProvider === 'ollama' && (
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('memory.ollama.recommended')}
                </p>
              </div>

              <div className="space-y-1">
                <Label className="text-xs text-muted-foreground">{t('memory.embedding.dimension')}</Label>
                <Input
                  type="number"
                  placeholder="768"
                ...
                />
                <p className="text-xs text-muted-foreground">
                  {t('memory.ollama.dimensionRequired')}
                </p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              {t('memory.database.nameDescription')}
            </p>
            <Input
