              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <h3 className="text-lg font-medium text-foreground">
                    {t('claudeOAuthFlow.authenticateWithClaude')}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t('claudeOAuthFlow.requiresAuth')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {t('claudeOAuthFlow.openBrowserWindow')}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-foreground">
                    {t('claudeOAuthFlow.authenticating')}
                  </h3>
                  <p className="text-sm text-muted-foreground mt-1">
                    {t('claudeOAuthFlow.terminalOpened')}
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-background/50 p-3 space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    <p className="font-medium">{t('claudeOAuthFlow.whatsHappening')}</p>
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      <li>{t('claudeOAuthFlow.step1')} <code className="px-1 bg-muted rounded">claude setup-token</code></li>
                      <li>{t('claudeOAuthFlow.step2')}</li>
                      <li>{t('claudeOAuthFlow.step3')}</li>
                      <li>{t('claudeOAuthFlow.step4')}</li>
                      <li>{t('claudeOAuthFlow.step5')}</li>
                    </ol>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-medium text-success">
                  {t('claudeOAuthFlow.successfullyAuthenticated')}
                </h3>
                <p className="text-sm text-success/80 mt-1">
                  {email ? t('claudeOAuthFlow.connectedAs', { email }) : t('claudeOAuthFlow.credentialsSaved')}
                </p>
                <div className="flex items-center gap-2 mt-3 text-xs text-success/70">
                  <Sparkles className="h-3 w-3" />
                  <span>{t('claudeOAuthFlow.canUseAiFeatures')}</span>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-destructive">
                    {t('claudeOAuthFlow.authenticationFailed')}
                  </h3>
          ...
          <div className="flex justify-center gap-3">
            <Button onClick={handleRetry} variant="outline">
              {t('claudeOAuthFlow.retry')}
            </Button>
            {onCancel && (
              <Button onClick={onCancel} variant="ghost">
                {t('claudeOAuthFlow.cancel')}
              </Button>
            )}
          </div>
        </div>
