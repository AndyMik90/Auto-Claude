      ...
      <AlertDialogContent className="sm:max-w-[500px]">
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="rounded-lg bg-primary/5 border border-primary/20 p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>{t('competitorAnalysis.searchesForFeedback')}</span>
              </li>
              <li className="flex items-start gap-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-foreground">
                  {t('competitorAnalysis.webSearchesTitle')}
                </h4>
                <p className="text-xs text-muted-foreground mt-1">
                  {t('competitorAnalysis.webSearchesDescription')}
                  {t('competitorAnalysis.webSearchesDetails')}
                  {t('competitorAnalysis.webSearchesNote')}
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {t('competitorAnalysis.optionalInfoNote')}
          </p>
        </div>

        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleDecline}>
            {t('competitorAnalysis.skipButton')}
          </AlertDialogCancel>
          <AlertDialogAction onClick={handleAccept}>
            {t('competitorAnalysis.enableButton')}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
