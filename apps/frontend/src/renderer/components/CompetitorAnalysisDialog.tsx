      ...
      <AlertDialogContent className="sm:max-w-[500px]">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-muted-foreground">
            {t('competitorDialog.description')}
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <div className="py-4 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-foreground">
                  {t('competitorDialog.webSearchesTitle')}
                </h4>
                <p className="text-xs text-muted-foreground mt-1">
                  {t('competitorDialog.webSearchesDescription')}
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            {t('competitorDialog.optionalInfo')}
          </p>
        </div>

        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleDecline}>
            {t('competitorDialog.skipButton')}
          </AlertDialogCancel>
          <AlertDialogAction onClick={handleAccept}>
            {t('competitorDialog.enableButton')}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
