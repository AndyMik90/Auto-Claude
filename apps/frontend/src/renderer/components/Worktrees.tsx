  ...
  if (!selectedProject) {
    return (
      <div className="flex h-full items-center justify-center">
        <p className="text-muted-foreground">{t('dialogs:worktrees.selectProjectToView')}</p>
      </div>
    );
  }
      ...
      {error && (
        <div className="mb-4 rounded-lg border border-destructive/50 bg-destructive/10 p-4 text-sm">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="font-medium text-destructive">{t('dialogs:worktrees.error')}</p>
            ...
            {worktrees.length > 0 && (
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                  ...
                  {t('dialogs:worktrees.taskWorktrees')}
                </h3>
            ...
            {terminalWorktrees.length > 0 && (
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                  ...
                  {t('dialogs:worktrees.terminalWorktrees')}
                </h3>
                    ...
                    <CardContent className="pt-0">
                      ...
                      {wt.createdAt && (
                        <div className="text-xs text-muted-foreground mb-4">
                          {t('dialogs:worktrees.created', { date: new Date(wt.createdAt).toLocaleDateString() })}
                        </div>
                      )}
              ...
              <div className="rounded-lg bg-muted p-4 text-sm space-y-3">
                ...
                <div className="border-t border-border pt-3 mt-3">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span>
                      {t('dialogs:worktrees.changesDetail', { commits: selectedWorktree.commitCount, files: selectedWorktree.filesChanged })}
                    </span>
                  </div>
                </div>
              </div>
