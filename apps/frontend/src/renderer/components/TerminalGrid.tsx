    ...
    return (
      <div className="flex h-full flex-col items-center justify-center gap-6 p-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">{t('terminal.agentTerminalsTitle')}</h2>
            <p className="mt-1 text-sm text-muted-foreground max-w-md">
              {t('terminal.spawnMultiple')}{' '}
              {t('terminal.useCtrlT')} <kbd className="px-1.5 py-0.5 text-xs bg-card border border-border rounded">Ctrl+T</kbd> {t('terminal.toCreateNew')}
            </p>
          </div>
        </div>
