  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="h-full flex flex-col">
      <TabsList className="shrink-0 mx-4 mt-4">
        ...
        <TabsTrigger value="phases">{t('phasesTab')}</TabsTrigger>
        <TabsTrigger value="features">{t('allFeatures')}</TabsTrigger>
        <TabsTrigger value="priorities">{t('byPriority')}</TabsTrigger>
      </TabsList>
            ...
            return (
              <Card key={priority} className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-muted-foreground">{features.length} {t('features')}</span>
                </div>
                  ...
                  {features.map((feature: RoadmapFeature) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        ...
                        >
                          {feature.impact} {t('impact').toLowerCase()}
                        </Badge>
