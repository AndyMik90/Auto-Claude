  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="h-full flex flex-col">
      <TabsList className="shrink-0 mx-4 mt-4">
        <TabsTrigger value="kanban">{t('views.kanban')}</TabsTrigger>
        <TabsTrigger value="phases">{t('views.phases')}</TabsTrigger>
        <TabsTrigger value="features">{t('views.allFeatures')}</TabsTrigger>
        <TabsTrigger value="priorities">{t('views.byPriority')}</TabsTrigger>
      </TabsList>
            ...
            return (
              <Card key={priority} className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-muted-foreground">{features.length} {t('summary.features')}</span>
                </div>
