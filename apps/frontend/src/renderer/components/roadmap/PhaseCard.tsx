    ...
    <Card className="p-4">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-sm mb-1">
          <span className="text-muted-foreground">{t('phase.progress')}</span>
          <span>
            {t('phase.featuresProgress', { done: completedCount, total: features.length })}
          </span>
        </div>
      ...
      {phase.milestones.length > 0 && (
        <div className="mb-4">
          <h4 className="text-sm font-medium mb-2">{t('phase.milestones')}</h4>
      ...
      {/* Features */}
      <div>
        <h4 className="text-sm font-medium mb-2">{t('phase.featuresLabel', { count: features.length })}</h4>
        <div className="grid gap-2">
          ...
          {features.length > 5 && (
            <div className="text-sm text-muted-foreground text-center py-1">
              {t('phase.moreFeatures', { count: features.length - 5 })}
            </div>
          )}
        </div>
      </div>
