      ...
      <DialogContent className="sm:max-w-[500px]">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t('envConfig.accountsAvailable', { count: claudeProfiles.length })} {t('envConfig.selectOneToUse')}
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {claudeProfiles.length > 0
                          ...
                          : t('envConfig.clickToAuthenticate')
                        }
                      </p>
                    </div>
                  </div>
            ...
            {hasExistingToken && (
              <div className="rounded-lg bg-muted/50 p-3">
                <p className="text-sm text-muted-foreground">
                  {t('envConfig.existingTokenInfo')} {showManualEntry ? t('envConfig.replaceToken') : t('envConfig.authenticateAgain')}
                </p>
              </div>
            )}
          </div>
        ...
        <DialogFooter>
          <Button variant="outline" onClick={handleClose} disabled={isSaving || isAuthenticating}>
            {success ? t('buttons.close') : t('buttons.cancel')}
          </Button>
