      ...
      <Card className="bg-muted/30 border-border/50">
        <CardContent className="pt-4">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline">{t('types.pr_review')}</Badge>
              ...
              <div className="flex items-center gap-2 mt-2 flex-wrap">
                ...
                {totalFindings > 0 && (
                  <span className="text-xs text-muted-foreground">
                    {totalFindings} {t('pr.findings', { count: totalFindings })}
                  </span>
                )}
              </div>
            ...
            {hasFindings && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('pr.keyFindings')}</span>
                ...
                <div className="space-y-2 pl-6">
                  {parsed.keyFindings.slice(0, 5).map((finding, idx) => (
                    <div key={idx} className="text-sm">
                      <div className="flex items-center gap-2">
                        <Badge
                          className={`text-xs ${finding.severity === 'critical' ? 'bg-red-600/20 text-red-400' :
                  ...
                  {parsed.keyFindings.length > 5 && (
                    <p className="text-xs text-muted-foreground">
                      {t('pr.moreFindings', { count: parsed.keyFindings.length - 5 })}
                    </p>
                  )}
                </div>
              </div>
            ...
            {hasGotchas && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('pr.gotchasTitle')}</span>
                  <Badge variant="secondary" className="text-xs px-1.5 py-0">
            ...
            {hasPatterns && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('pr.patternsTitle')}</span>
                  <Badge variant="secondary" className="text-xs px-1.5 py-0">
