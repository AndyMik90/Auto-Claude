      ...
      <div className="p-6 space-y-6">
            ...
            {memoryStatus?.available ? (
              <>
                <div className="grid gap-3 sm:grid-cols-2 text-sm">
                  <InfoItem label={t('status.database')} value={memoryStatus.database || 'auto_claude_memory'} />
                  <InfoItem label={t('status.path')} value={memoryStatus.dbPath || '~/.auto-claude/memories'} />
                </div>
                  ...
                  <div className="pt-3 border-t border-border/50">
                    <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                      <div className="text-center p-2 rounded-lg bg-muted/30">
                        ...
                        <div className="text-xs text-muted-foreground">{t('status.total')}</div>
                      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground">
              {t('browser.stats', { filtered: filteredMemories.length, total: recentMemories.length })}
            </span>
          </div>
