            ...
            >
              {expanded ? (
                ...
                <>
                  ...
                  {t('common:buttons.expand', 'Expand')}
                </>
              )}
            </Button>
          )}
        ...
        {expanded && parsed && (
          <div className="mt-4 space-y-4 pt-4 border-t border-border/50">
            ...
            {parsed.what_worked && parsed.what_worked.length > 0 && (
              <div>
                <SectionHeader icon={CheckCircle2} title={t('memories.memoryCard.whatWorked')} count={parsed.what_worked.length} />
            ...
            {parsed.what_failed && parsed.what_failed.length > 0 && (
              <div>
                <SectionHeader icon={XCircle} title={t('memories.memoryCard.whatFailed')} count={parsed.what_failed.length} />
                <ul className="space-y-0.5">
            ...
            {parsed.discoveries?.approach_outcome?.approach_used && (
              <div>
                <SectionHeader
                  ...
                  title={t('memories.memoryCard.approach')}
                />
            ...
            {((parsed.recommendations_for_next_session?.length ?? 0) > 0 ||
              ...
              <div>
                <SectionHeader
                  icon={Lightbulb}
                  title={t('memories.memoryCard.recommendations')}
            ...
            {parsed.discoveries?.patterns_discovered && parsed.discoveries.patterns_discovered.length > 0 && (
              <div>
                <SectionHeader icon={Sparkles} title={t('memories.memoryCard.patterns')} count={parsed.discoveries.patterns_discovered.length} />
            ...
            {parsed.discoveries?.gotchas_discovered && parsed.discoveries.gotchas_discovered.length > 0 && (
              <div>
                <SectionHeader icon={AlertTriangle} title={t('memories.memoryCard.gotchas')} count={parsed.discoveries.gotchas_discovered.length} />
                <ul className="space-y-0.5">
            ...
            {parsed.discoveries?.changed_files && parsed.discoveries.changed_files.length > 0 && (
              <div>
                <SectionHeader icon={FileCode} title={t('memories.memoryCard.changedFiles')} count={parsed.discoveries.changed_files.length} />
            ...
            {parsed.discoveries?.file_insights && parsed.discoveries.file_insights.length > 0 && (
              <div>
                <SectionHeader icon={FileCode} title={t('memories.memoryCard.fileInsights')} count={parsed.discoveries.file_insights.length} />
            ...
            {parsed.subtasks_completed && parsed.subtasks_completed.length > 0 && (
              <div>
                <SectionHeader icon={CheckCircle2} title={t('memories.memoryCard.subtasksCompleted')} count={parsed.subtasks_completed.length} />
                <div className="flex flex-wrap gap-1.5 pl-4">
