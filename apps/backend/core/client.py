...
# =============================================================================
# Language injection is handled by core.language_injection module
# This provides a single source of truth for all language preference handling

from core.language_injection import inject_language_strengthened, get_user_language_preference
...
def create_client(
    ...
    # Include CLAUDE.md if enabled and present (BEFORE language instruction)
    ...
    # Add user language preference to system prompt (use strengthened version)
    # MUST be injected LAST (after CLAUDE.md) to ensure it's the final instruction
    user_language = get_user_language_preference()
    base_prompt = inject_language_strengthened(base_prompt, agent_type)

    # Log language preference
    from core.language_injection import DEFAULT_LANGUAGE
