...
class TestPhase:
    ...
    def test_create_phase(self):
        ...
        chunk1 = Subtask(id="c1", description="Subtask 1")
        chunk2 = Subtask(id="c2", description="Subtask 2")
    ...
    def test_phase_is_complete(self):
        ...
        chunk1 = Subtask(id="c1", description="Subtask 1", status=SubtaskStatus.COMPLETED)
        chunk2 = Subtask(id="c2", description="Subtask 2", status=SubtaskStatus.COMPLETED)
    ...
    def test_phase_not_complete_with_pending(self):
        ...
        chunk1 = Subtask(id="c1", description="Subtask 1", status=SubtaskStatus.COMPLETED)
        chunk2 = Subtask(id="c2", description="Subtask 2", status=SubtaskStatus.PENDING)
        phase = Phase(phase=1, name="Test", subtasks=[chunk1, chunk2])
    ...
    def test_phase_get_pending_chunks(self):
        ...
        chunk1 = Subtask(id="c1", description="Subtask 1", status=SubtaskStatus.COMPLETED)
        chunk2 = Subtask(id="c2", description="Subtask 2", status=SubtaskStatus.PENDING)
        chunk3 = Subtask(id="c3", description="Subtask 3", status=SubtaskStatus.PENDING)
        ...
        phases_config = [
            {
                ...
                "parallel_safe": True,
                "chunks": [
                    {"id": "c1", "description": "Subtask 1"},
                    {"id": "c2", "description": "Subtask 2"},
                ],
            },
        ]
