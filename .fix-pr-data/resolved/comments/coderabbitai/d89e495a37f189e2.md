...
<details>
<summary>🧪 Mock validation to keep this test deterministic</summary>
...
**Resolution:** Integration test design choice - test validates limit enforcement; API key requirement is expected for integration tests