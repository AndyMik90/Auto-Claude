...
class BMBModule:
    ...
    builder_agent: BMBAgent | None = None
...
class BMBModuleLoader:
    ...
    def __init__(
        ...
        self._module: BMBModule | None = None
    ...
    def _load_agent(self, agent_path: Path) -> BMBAgent | None:
    ...
    def get_builder_agent(self) -> BMBAgent | None:
    ...
    def get_workflow(self, name: str) -> BMBWorkflow | None:
        module = self.load()
    ...
    def get_example_agent(self, name: str) -> ExampleAgent | None:
